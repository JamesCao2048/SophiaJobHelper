...
% DIVERSITY
% ============================================
\section{Diversity Experience and Supporting Efforts}

During my long educational journey, \textbf{there were three key moments when many women, including myself, faced barriers to continuing higher education.} The first moment occurred in middle school, when teachers frequently told us that female students perform well because success at that stage relies on memorization, while male students would later excel in subjects requiring logic and reasoning. This implicit bias discouraged many of my female classmates from pursuing further studies. The second moment came in high school, where girls were often steered toward subjects such as history or politics rather than physics, chemistry, or mathematics, which are courses that serve as essential foundations for higher education in computing and AI. This made the gap between genders in opportunities even wider. The third moment emerged during my undergraduate studies, when I witnessed many female peers losing confidence due to long-standing stereotypes suggesting that women are less capable of coding or tackling technically demanding problems.\footnote{\url{https://quillette.com/2018/06/19/why-women-dont-code/}} Consequently, many may choose not to pursue postgraduate studies.

My personal experience mirrors a broader global pattern: computer science remains one of the least diverse fields in higher education. In the United States, for instance, women constitute only about 20\% of computer science PhD recipients.\footnote{\url{https://ncses.nsf.gov/pubs/nsf21321/report/field-of-degree-women}} Yet my own journey in computer science has shown that \textbf{students of all genders can thrive when provided with equitable opportunities and supportive environments.} These experiences reinforce my commitment to fostering inclusive academic spaces that empower underrepresented groups to succeed in computing.

In response, I am currently engaged in and will continue my supporting efforts, as a faculty member, by:

\begin{itemize}[leftmargin=1.5em, itemsep=0.4em, topsep=0.2em]
